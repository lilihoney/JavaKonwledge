...
public class JavaReflection {  
    ...
    {  
        ...
        class1 = Class.forName("com.qll.reflection.Person");  
    ...
    {  
        ...
        person2 = (Person) constructors[1].newInstance(20,"leeFeng","男");  
     ...
     * @throws ClassNotFoundException  
     */  
    public static void demo5() throws IllegalArgumentException, IllegalAccessException, 
    ...
    {  
        ...
        Field personGenderField = class1.getDeclaredField("gender");
        personGenderField.setAccessible(true);
        personGenderField.set(obj, "女");
        
        Field personAgeField = class1.getDeclaredField("age");
        personAgeField.setAccessible(true);
        personAgeField.set(obj, 80);          
          
        System.out.println("demo5: 修改属性之后得到属性变量的值："
        				+ personNameField.get(obj)+ " : "+personAgeField.getInt(obj)
        				+ personGenderField.get(obj));  
    ...
    {  
        Class<?> class1 = null;  
        class1 = Class.forName("com.qll.reflection.SuperMan");  
